        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('razorpay_plan_id')
                    ->maxLength(255),
                ...
                Forms\Components\TextInput::make('price_yearly')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('max_invoices_per_month')
                    ->required()
                    ->numeric()
                    ->default(0),
                Forms\Components\TextInput::make('max_organizations')
                    ->required()
                    ->numeric()
                    ->default(1),

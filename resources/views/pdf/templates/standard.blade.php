    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                @if($invoice->invoice_type->value === 'sales' && (isset($template->show_fields['hsn']) ? $template->show_fields['hsn'] : true))
                    <td class="text-center">{{ $item->hsn_code ?? '-' }}</td>
                @elseif($invoice->invoice_type->value === 'service' && (isset($template->show_fields['hsn']) ? $template->show_fields['hsn'] : true))
                    <td class="text-center">{{ $item->hsn_code ?? '-' }}</td>
                @endif

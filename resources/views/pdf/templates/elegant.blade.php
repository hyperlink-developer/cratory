            ...
            <td style="width: 65%; vertical-align: top; border: none; padding: 0;">
                @if($invoice->payment_info)
                    <div style="margin-bottom: 20px;">
                        <h4 style="margin: 0 0 5px 0; font-size: 12px; color: {{ $template->color_primary ?? '#1E293B' }}; text-transform: uppercase; letter-spacing: 1px;">Payment Information</h4>
                        <p style="margin: 0; font-size: 11px; color: #555; white-space: pre-wrap;">{{ $invoice->payment_info }}</p>
                    </div>
                @endif

                @if($invoice->terms_and_conditions)
                    <div>
                        <h4 style="margin: 0 0 5px 0; font-size: 12px; color: {{ $template->color_primary ?? '#1E293B' }}; text-transform: uppercase; letter-spacing: 1px;">Terms & Conditions</h4>
                        <p style="margin: 0; font-size: 11px; color: #555; white-space: pre-wrap;">{{ $invoice->terms_and_conditions }}</p>
                    </div>
                @endif
            </td>

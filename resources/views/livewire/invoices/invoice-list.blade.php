                ...
                <div class="p-4 flex flex-col gap-3">
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-white/5">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('invoices.pdf', $invoice->uuid) }}" class="p-1.5 text-text-muted hover:text-green-400 transition-colors" title="Download PDF" target="_blank">
                        ...
                        <tr class="hover:bg-white/5 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ route('invoices.pdf', $invoice->uuid) }}" class="p-1.5 rounded-lg text-text-muted hover:text-green-400 hover:bg-green-400/10 transition-colors" title="Download PDF" target="_blank">

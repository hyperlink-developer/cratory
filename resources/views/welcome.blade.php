        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 auto-rows-min">
                ...
                <div class="glass-card rounded-3xl p-8 lg:p-10 border border-white/5 hover:border-blue-500/30 transition-all duration-300 bg-surface-light">
                    ...
                    <h4 class="text-xl font-bold text-white mb-3">GST & E-Invoicing</h4>
                    <p class="text-text-muted leading-relaxed">Stay compliant instantly. Generate NIC schema payloads, IRNs, and E-Way Bills directly from the dashboard.</p>
                </div>

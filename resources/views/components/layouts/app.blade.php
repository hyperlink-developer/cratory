...
<body class="antialiased">
    ...
    <div x-data="{ open: false }" 
        ...
        <div x-show="open" 
             ...
             class="fixed inset-x-0 glass-dropdown rounded-t-3xl border-t border-white/10 p-6 pb-6 shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.5)]"
            ...
            <div class="space-y-2">
                <a href="{{ route('profile') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-xl hover:bg-white/5 text-text-primary text-base font-medium transition-colors">
                ...
                <a href="{{ route('contacts.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-xl hover:bg-white/5 text-text-primary text-base font-medium transition-colors">
                    <svg class="w-6 h-6 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                    </svg>
                    Contacts
